...
grep -q "DEADFALL_SQUAD_JOIN_ACCEPTED" "$CLIENT_A_LOG"
grep -q "DEADFALL_SQUAD_JOIN_ACCEPTED" "$CLIENT_B_LOG"
grep -q "DEADFALL_DUO_SNAPSHOT players=2" "$CLIENT_A_LOG"
grep -q "DEADFALL_DUO_SNAPSHOT players=2" "$CLIENT_B_LOG"
echo "NEXORA: DEADFALL duo regression integration smoke passed"
